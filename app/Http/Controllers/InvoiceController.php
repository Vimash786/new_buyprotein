...
class InvoiceController extends Controller
{
    ...
    /**
     * Download standard invoice PDF for admin or user
     */
    public function downloadStandardInvoice($orderId)
    {
        $user = Auth::user();
        ...
        // Standard invoice requires a seller object. We'll use the first item's seller or a default BuyProtein seller.
        $seller = $order->orderSellerProducts->first()->seller ?? (object)[
            'company_name' => 'BuyProtein',
            'business_address' => '123 Business District, Tech Park',
            'city' => 'Bangalore',
            'state' => 'Karnataka',
            'pincode' => '560001',
            'country' => 'India'
        ...
        return $pdf->download('standard-invoice-' . $order->order_number . '.pdf');
    }
}
