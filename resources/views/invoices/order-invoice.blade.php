    ...
    <div class="invoice-details">
        <div style="display: flex; justify-content: space-between;">
            <div>
                ...
                <span class="status-badge status-{{ $order->overall_status }}">{{ ucfirst(str_replace('_', ' ', $order->overall_status)) }}</span>
            </div>
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 30px;">
        <div style="width: 48%;">
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px;">
                <strong>BuyProtein</strong><br>
                Professional Nutrition & Supplements<br>
                Email: support@buyprotein.com<br>
                Website: www.buyprotein.com
            </div>
        </div>
            ...
            <tr>
                ...
                <td>
                    @if($item->variantCombination)
                        {{ $item->variantCombination->variant_options ?? 'N/A' }}
                    @else
                        Standard
                    @endif
                </td>
    ...
    <div class="total-section">
        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; display: inline-block; min-width: 300px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                <span>Subtotal:</span>
                <span>₹{{ number_format($order->total_order_amount, 2) }}</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
