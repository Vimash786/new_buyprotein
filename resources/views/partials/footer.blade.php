    ...
    <div class="container">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <div class="information">
                ...
                <p class="disc">
                Get unbeatable prices on premium protein & bodybuilding supplements.
                </p>
            </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <div class="information">
                ...
                <p class="disc">
                Guaranteed genuine supplements from authorized brands only.
                </p>
            </div>
            </div>
            <!-- single service area end -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <div class="information">
                <h4 class="title">Expert Fitness Support</h4>
                <p class="disc">
                Get professional advice from certified fitness experts 24/7.
                </p>
            </div>
            </div>
            <!-- single service area end -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <div class="information">
                ...
                <p class="disc">
                Quick delivery on all protein supplements and workout nutrition.
                </p>
            </div>
            </div>
            <!-- single service area end -->
