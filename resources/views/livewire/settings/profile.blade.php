                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <flux:field>
                                ...
                                <div wire:loading wire:target="brand_logo_file" class="flex items-center mt-2">
                                    <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                    <span class="text-sm text-blue-600">Uploading logo...</span>
                                </div>
                                
                                <p class="text-xs text-gray-500 mt-1">Upload JPG, JPEG, PNG, or GIF files (max 10MB)</p>
                                
                                @if($brand_logo_file)
                                    <div class="mt-2 p-2 bg-green-50 border border-green-200 rounded text-sm text-green-700 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
                                        File ready: {{ $brand_logo_file->getClientOriginalName() }}
                                    </div>
                                @endif
