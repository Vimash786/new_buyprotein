...
new class extends Component
{
    ...
    public $gym_owner_discount = '';
    public $regular_user_discount = '';
    public $shop_owner_discount = '';
    ...
    public function resetForm()
    {
        ...
        $this->gym_owner_discount = '';
        $this->regular_user_discount = '';
        $this->shop_owner_discount = '';
